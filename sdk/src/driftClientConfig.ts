...
import { HeliusDriftClientAccountSubscriber } from './accounts/heliusDriftClientAccountSubscriber';
...
export type DriftClientSubscriptionConfig =
	...
	| {
		...
		perpMarketAccountSubscriber?: new (
			...
			resubOpts?: ResubOpts,
			commitment?: Commitment
		) => WebSocketAccountSubscriberV2<any> | WebSocketAccountSubscriber<any> | HeliusDriftClientAccountSubscriber;
